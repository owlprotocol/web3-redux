...
declare const ReactLiveScope: {
    ...
    createFactory<P_2>(
        type: React.ClassType<P_2, React.ClassicComponent<P_2, any>, React.ClassicComponentClass<P_2>>,
    ): React.CFactory<P_2, React.ClassicComponent<P_2, any>>;
    createFactory<P_3, T_2 extends React.Component<P_3, any, any>, C extends React.ComponentClass<P_3, any>>(
    ...
    createElement<P_9 extends {}>(
        type: React.ClassType<P_9, React.ClassicComponent<P_9, any>, React.ClassicComponentClass<P_9>>,
        props?: (React.ClassAttributes<React.ClassicComponent<P_9, any>> & P_9) | null | undefined,
        ...children: React.ReactNode[]
    ...
    cloneElement<P_18>(
        element: React.ReactElement<P_18, string | React.JSXElementConstructor<any>>,
    ...
    ): object is React.ReactElement<P_19, string | React.JSXElementConstructor<any>>;
    createRef<T_13>(): React.RefObject<T_13>;
    forwardRef<T_14, P_20 = {}>(
        render: React.ForwardRefRenderFunction<T_14, P_20>,
    ): React.ForwardRefExoticComponent<React.PropsWithoutRef<P_20> & React.RefAttributes<T_14>>;
    memo<P_21 extends object>(
        Component: React.FunctionComponent<P_21>,
        propsAreEqual?: ((prevProps: Readonly<P_21>, nextProps: Readonly<P_21>) => boolean) | undefined,
    ...
    Children: {
        ...
        ): C_2 extends null | undefined ? C_2 : Exclude<T_26, boolean | null | undefined>[];
