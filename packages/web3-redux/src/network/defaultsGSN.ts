import { NetworkGSN } from './model/interfaceGSN.js';
import {
    ETHERSCAN_API_KEY,
    MAINNET_RPC,
    ROPSTEN_RPC,
...
export const defaultGSNNetworks = () => {
    return {
        '1': {
            networkId: '1',
            name: 'Mainnet',
        ...
        /*         '300': {
            ...
            currency: xDAI,
            web3Rpc: "https://optimism.gnosischain.com",
        ...
        '43113': {
            ...
            currency: AVAX,
            web3Rpc: 'https://api.avax-test.network/ext/bc/C/rpc',
        ...
        '97': {
            ...
            name: 'BSC Testnet',
            currency: BNB,
            web3Rpc: 'https://data-seed-prebsc-1-s1.binance.org:8545/',
        ...
        '100': {
            ...
            name: 'Gnosis Chain',
            currency: xDAI,
            web3Rpc: 'https://rpc.gnosischain.com ',
        ...
        '61': {
            ...
            name: 'ETC Mainnet',
            currency: ETC,
            web3Rpc: 'https://ethereumclassic.org/network/endpoints',
            explorer:'https://ethereumclassic.org/network/explorers',
    ...
    } as { [networkId: string]: NetworkGSN | undefined };
};

export default defaultGSNNetworks;
