...
const totalSupplyAbi = Abi.IERC20Artifact.abi.find((a) => a.name === 'totalSupply')!;
const {
...
//eslint-disable-next-line @typescript-eslint/no-non-null-assertion
const balanceOfAbi = Abi.IERC20Artifact.abi.find((a) => a.name === 'balanceOf')!;
const {
    name: nameBalanceOf,
...
//eslint-disable-next-line @typescript-eslint/no-non-null-assertion
const transferAbi = Abi.IERC20Artifact.abi.find((a) => a.name === 'transfer')!;
